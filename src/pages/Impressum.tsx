...
const Impressum = () => {
  return (
    <>
      <Helmet>
        <title>Impressum | FB Barbershop Wien</title>
        <meta 
          name="description" 
              ...
              <div className="max-w-3xl mx-auto">
                <div className="space-y-8 text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p>
                      Große Mohrengasse 38, 1020 Wien<br />
                      1020 Wien<br />
                      Österreich
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Telefon: <a href="tel:+436645477777" className="text-primary hover:underline">+43 6645477777</a><br />
                      E-Mail: <a href="mailto:fbbarbershopkg@gmail.com" className="text-primary hover:underline">fbbarbershopkg@gmail.com</a>
                    </p>
                  </div>
