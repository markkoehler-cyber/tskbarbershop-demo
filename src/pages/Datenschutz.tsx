...
const Datenschutz = () => {
  return (
    <>
      <Helmet>
        <title>Datenschutz | FB Barbershop Wien</title>
        <meta 
          name="description" 
              ...
              <div className="max-w-3xl mx-auto">
                <div className="space-y-10 text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p>
                      E-Mail: <a href="mailto:fbbarbershopkg@gmail.com" className="text-primary hover:underline">fbbarbershopkg@gmail.com</a><br />
                      Telefon: <a href="tel:+436645477777" className="text-primary hover:underline">+43 6645477777</a>
                    </p>
                  </div>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4">
                      8. Digitaler Receptionist (Placetel AI)
                    </h2>
                    <p className="leading-relaxed mb-4">
                      Zur Unterstützung der Terminverwaltung nutzen wir einen digitalen 
                      Receptionist-Dienst (Placetel AI).
                    </p>
                    <p className="leading-relaxed mb-4">
                      Dabei werden nur jene Daten verarbeitet, die Sie freiwillig im Rahmen 
                      Ihrer Anfrage angeben.
                    </p>
                    <p className="leading-relaxed mb-4">
                      Die Verarbeitung erfolgt ausschließlich zum Zweck der Terminorganisation.
                    </p>
                    <p className="text-sm">
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-bold text-foreground mb-4">
                      9. Terminbuchung & Google Kalender
                    </h2>
                    <p className="leading-relaxed mb-4">
