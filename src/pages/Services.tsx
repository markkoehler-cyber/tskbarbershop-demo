...
const services = [
  ...
  {
    icon: Crown,
    title: 'Schneiden + Föhnen + Waschen',
    description: 'Das Rundum-Erlebnis: Schneiden, Föhnen, und Waschen.',
    price: 'ab €30',
    duration: '45 Min',
  },
  {
    ...
    description: 'Inklusive Föhnen. Wir beraten ihr Kind individuell zu den besten Optionen für das Haar.',
    price: 'ab €18',
    duration: '30 Min',
  },
  {
...
const Services = () => {
  return (
    <>
      <Helmet>
        <title>Unsere Services | FB Barbershop Wien</title>
        <meta 
          name="description" 
