...
const testimonials = [
  {
    id: 1,
    name: 'Gerson Dibra',
    role: 'Stammkunde seit 2022',
    content: 'Ein absolut fantastisches Erlebnis! Der Salon war sauber, die Atmosphäre entspannt und Mouhaned hat mir einen unglaublichen Haarschnitt verpasst. Er war professionell, freundlich und hat sich wirklich Zeit genommen, um alles perfekt zu machen. Sehr empfehlenswert – ich komme auf jeden Fall wieder!',
    rating: 5,
  },
  {
    id: 2,
    ...
    content: 'Der beste Friseursalon in Wien! Mouhaned ist einfach der beste Friseur überhaupt – professionell, präzise und dazu noch super sympathisch! Kann ich nur empfehlen, wenn ihr einen frischen Haarschnitt wollt! 💪🏿 …',
    rating: 5,
  },
  {
    id: 3,
    name: 'Neo Darwin',
    role: 'Neuer Kunde',
    content: 'Dieser Friseursalon ist fantastisch! Ich bin ohne Termin reingegangen und wurde trotzdem bedient (ich würde aber trotzdem empfehlen, vorher zu reservieren, um es ihnen leichter zu machen).',
    rating: 5,
  },
  {
    id: 4,
    name: 'Nazarii Makhovyk',
    role: 'Stammkunde seit 2024',
    content: 'Das Team war äußerst freundlich und professionell. Mein Friseur hat genau zugehört und meine Wünsche perfekt umgesetzt. Das Ergebnis hat meine Erwartungen übertroffen - ich habe endlich den besten Look meines Lebens👍',
    rating: 5,
  },
];
